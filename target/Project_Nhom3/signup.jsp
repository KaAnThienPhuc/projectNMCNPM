...
<%--            <span class="form__span">hoặc dùng email để đăng ký</span>--%>
            ...
            <input style="margin-top: 0px; background: #C4946DFF" type="submit" class="button" value="ĐĂNG KÝ">
        </form>
    </div>
    <div class="switch" id="switch-cnt">
        ...
        <div class="switch__container" id="switch-c1">
            ...
            <a href="login.jsp">
                <button class="switch__button button switch-btn" style="background-color: #C4946DFF">ĐĂNG NHẬP</button>
            </a>
        </div>
    </div>
</div>
