                ...
                <div id="banner" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="images/bgcf1.png">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="images/bgcf2.png">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="images/bgcf3.png">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="images/bgcf4.png">
                        </div>
                    </div>
